...
class IntegerDivisionTest {
    ...
    @Test
    void divide_shouldReturnFormattedQuotientAndResult_WhenCasualInput_1() {
        DivisionResult expected = new DivisionResult(
                Arrays.asList(new DivisionStep(123, 123, 3),
                        new DivisionStep(456, 369, 6)),123,123456,87 ,1003 );

        assertEquals(expected, integerDivision.divide(123456, 123));
    }
    
    @Test
    void divide_shouldReturnFormattedQuotientAndResult_WhenCasualInput_2() {
        DivisionResult expected = new DivisionResult(
    ...
    @Test
    void divide_shouldReturnFormattedQuotientAndResult_WhenZeroDividendInput_3() {
        DivisionResult expected = new DivisionResult(
                Arrays.asList(new DivisionStep(0,0,1)),12,0,0,0);
